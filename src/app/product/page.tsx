  ...
  return (
    <>
      ...
      >
        ...
        >
          <div>
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">왜 더 발판인가요?</h2>
        ...
        >
          {[
            {
              title: '인체공학 설계',
              desc: '자세를 개선하고 다리 피로도를 낮춰줍니다.',
            },
            {
              title: '미끄럼 방지',
              desc: '안전한 고정력으로 어디서든 안심하고 사용하세요.',
            },
            {
              title: '감성 디자인',
              desc: '어느 공간에서도 자연스럽게 어울리는 미니멀 스타일.',
            },
          ].map((item, i) => (
            <motion.div
              key={i}
